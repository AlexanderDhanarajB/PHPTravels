...
*/
	public void beforeAlertAccept(WebDriver driver) {
		System.out.println("The alert will be accepted");
//		//takeSnap();
	}
...
//		//takeSnap();
	...
	public void beforeAlertDismiss(WebDriver driver) {
		System.out.println("The alert will be dismissed");
//		//takeSnap();
	}

	public void beforeNavigateTo(String url, WebDriver driver) {
		System.out.println("The browser will load the URL "+url);
		//takeSnap();
	}
	...
	public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
		//System.out.println("The value "+keysToSend[0]+" is entered successfully in element ");
		//takeSnap();
	}
...
//		//takeSnap();
	...
	public long takeSnap() {
		...
		try {
			...
			e.printStackTrace();
			//reportSteps("There is some issue with browser", "Fail");
		} catch (IOException e) {
			e.printStackTrace();
		//	reportSteps("There is some issue with input file", "Fail");
		}
//		i++;
		return number;
	}
